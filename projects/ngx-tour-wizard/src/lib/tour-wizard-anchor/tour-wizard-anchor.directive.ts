...
export class TourWizardAnchorDirective implements OnInit, OnDestroy {
  ...
  protected _popperTarget!: HTMLElement | any;
  protected _remoteTarget!: HTMLElement | any;
  ...
  getPopperTarget(): HTMLElement | undefined {
  ...
  hideTourStep(): void {
    ...
    this.hasRemoteTarget && this._remoteTarget && this._remoteTarget.classList.remove(remoteAnchorShowClassname);
  ...
  protected _isDOMElement(entity: any): boolean {
    if (!entity) {
      return false;
    }
