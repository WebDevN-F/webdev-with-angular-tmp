...
export class TourWizardOverlayComponent {
    ...
    topStyle: TourWizardOverlayStyle | undefined;
    bottomStyle: TourWizardOverlayStyle | undefined;
    leftStyle: TourWizardOverlayStyle | undefined;
    rightStyle: TourWizardOverlayStyle | undefined;
    showCover: boolean = !0;
